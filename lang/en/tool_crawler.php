 ...
 */
$string['httpcode_100'] = 'The server is waiting to receive request payload body';
$string['httpcode_101'] = 'The server agree to switch protocols specified in client\'s request header';
$string['httpcode_200'] = 'The request has succeeded.';
$string['httpcode_201'] = 'The request has resulted in creating new resource.';
$string['httpcode_202'] = 'The processing is not completed.';
$string['httpcode_203'] = 'The payload has been modified.';
$string['httpcode_204'] = 'There is no additional content.';
$string['httpcode_205'] = 'The server request user agent to reset "document view" to its original state.';
$string['httpcode_300'] = 'There are more than one representations for the requested resource.';
$string['httpcode_301'] = 'There is a new permanent URI for the requested resource.';
$string['httpcode_302'] = 'There is a different temporary URI for the requested resource.';
$string['httpcode_303'] = 'The request is redirected to a different resource';
$string['httpcode_400'] = 'The server cannot process the request due to client error.';
$string['httpcode_401'] = 'The request requires user authentication.';
$string['httpcode_403'] = 'The server refuses to authorize the request. ';
$string['httpcode_404'] = 'The server cannot find the requested resource.';
$string['httpcode_405'] = 'The request method is not supported by the server.';
$string['httpcode_406'] = 'The requested resource is not acceptable to the user agent.';
$string['httpcode_408'] = 'The server cannot complete the request within a specified time.';
$string['httpcode_409'] = 'There is a conflict in the current state of the requested resource.';
$string['httpcode_410'] = 'The requested resource is no longer available.';
$string['httpcode_411'] = 'There is no defined Content-Length in the request.';
$string['httpcode_413'] = 'The request payload is too large.';
$string['httpcode_414'] = 'The request URI is too long for server to interpret.';
$string['httpcode_415'] = 'The media type is not supported.';
$string['httpcode_417'] = 'The expectation given cannot be met by inbound servers.';
$string['httpcode_500'] = 'The server encountered error.';
$string['httpcode_501'] = 'The functionality is not supported by the server';
$string['httpcode_502'] = 'Invalid response from inbound server.';
$string['httpcode_503'] = 'Temporary overload or scheduled maintenance';
$string['httpcode_504'] = 'The server did not receive a timely response from an upstream server.';
$string['httpcode_505'] = 'The version of HTTP is not supported by the server.';
