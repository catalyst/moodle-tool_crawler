...
$string['coursemode_desc'] = 'If enabled, only crawl links in courses where the link crawler is enabled. "uselogs" and "seed url" will be ignored';
...
$string['emailto_desc'] = 'An email will be sent to the specified email address when link checking is completed in a course';
...
$string['onqueue'] = 'The link checking haven\'t started yet';
